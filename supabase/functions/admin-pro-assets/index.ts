...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    let query = supabase
      ...
      .select("id, user_id, created_at, title, cdn_provider, external_asset_id, playback_url, thumbnail_url, duration_seconds, status, metadata_json")
    ...
    console.error("admin-pro-assets error:", err);
    return new Response(
